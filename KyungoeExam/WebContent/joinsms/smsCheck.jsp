...
<script src="https://code.jquery.com/jquery-3.6.3.min.js" integrity="sha256-pvPw+upLPUjgMXY0G+8O0xUf+/Im1MZjXxxgOcBQBXU=" crossorigin="anonymous"></script>
    ...
    String user_id = base64Encode("tlarruddhl"); //아이디
    String secure = base64Encode("c916b4b6110b759545dd5614c76dc55b");//인증키
    ...
    String sphone2 = base64Encode("2594");
    String sphone3 = base64Encode("3099");
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">SMS발송성공</h1>
