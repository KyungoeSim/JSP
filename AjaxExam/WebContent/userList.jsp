...
<script type="text/javascript">
	...
	function registerFunction() {
		searchRequest.open("Post", "./UserRegisterServlet?userName=" + encodeURIComponent(document.getElementById('userName').value)
		+"&userAge="+encodeURIComponent(document.getElementById('userAge').value)
		+"&userGender="+encodeURIComponent($('input[name=registerGender]:checked').val())
		+"&userEmail="+encodeURIComponent(document.getElementById('userEmail').value)
		, true);
 ...
 <div class="container">
	<table class="table table-dark">
		...
		<tbody>
			...
			<tr>
				<td colspan="2" style="text-align: center;"><button class="btn btn-success pull-right" onclick="registerFunction();" type="button">Send</button></td>
			</tr>
		</tbody>
	</table>
</div>
